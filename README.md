...
| <a id="release-manager"></a>[**release-manager**](skills/release-manager/) | 2.2.0 | ![max](https://img.shields.io/badge/max-darkred) | Version bump, changelog, tags, GitHub release, PyPI/npm publish |
