...
| <a id="release-manager"></a>[**release-manager**](skills/release-manager/) | 2.2.0 | - | Version bump, changelog, tags, GitHub release, PyPI/npm publish |
...
| <a id="readme-to-landing-page"></a>[**readme-to-landing-page**](skills/readme-to-landing-page/) | 2.0.0 | high | Transform any README into a landing page (PAS, AIDA, StoryBrand) |
...
| <a id="note-taker"></a>[**note-taker**](skills/note-taker/) | 1.4.1 | - | Git-backed notes (text, voice, images) with task extraction |
...
| <a id="skill-creator"></a>[**skill-creator**](skills/skill-creator/) | 1.1.0 | high | Create, validate, and package your own skills |
